...
## 5. Roadmap / 候选清单（2026-09-10 登记 8 条；发送失败兜底、关闭视图误弹、回收站自动清理、发送音效、标签渲染位置已完成闭环，余 3 条未排期——动手前先 grill 细化）
