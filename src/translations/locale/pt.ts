...
export default {
  ...
  '{files} files · {lines} memos · {issues} issues': '{files} ficheiros · {lines} memos · {issues} problemas',
  ...
  'Migrating…': 'A migrar…',
  'Convert the legacy rows of this file into card blocks (automatic backup). Your memos show up in the feed again afterwards.': 'Converte as linhas em formato antigo deste ficheiro em blocos-cartão (cópia de segurança automática). Os seus memos voltam a aparecer na lista.',
  ...
  'no auto-fixable issues': 'sem problemas corrigíveis automaticamente',
  'cannot auto-fix further — the remaining issues need manual work or a migration': 'não é possível continuar a correção automática — os problemas restantes exigem intervenção manual ou migração',
  ...
  'Migrated all: {files} files · {n} entries converted': 'Migração completa: {files} ficheiros · {n} entradas convertidas',
  ', {n} cross-day comments moved to their daily notes': ', {n} comentários entre dias movidos para as respetivas notas diárias',
  ', {n} deleted comments dropped': ', {n} comentários eliminados descartados',
  ', {n} entries kept as-is (could not be mapped)': ', {n} entradas mantidas como estavam (não mapeáveis)',
  ', failed: {list}': ', falhas: {list}',
  '. Backups are in .rememo-backup/migrate-*. Your old memos are now card blocks.': '. As cópias estão em .rememo-backup/migrate-*. Os seus memos antigos são agora blocos-cartão.',
  '. Backups are in .rememo-backup/migrate-*.': '. As cópias estão em .rememo-backup/migrate-*.',
  'Nothing to migrate ({n} lines lack a time and need manual work).': 'Nada a migrar ({n} linhas sem hora, requerem trabalho manual).',
  'This file has no legacy-format lines — no migration needed.': 'Este ficheiro não tem linhas em formato antigo — não é precisa migração.',
