...
export default {
  ...
  'Recently fixed': '✅ Corrigés récemment',
  Clear: 'Effacer',
  ...
  '{files} files · {lines} memos · {issues} issues': '{files} fichiers · {lines} memos · {issues} problèmes',
  ' (incl. {n} legacy-format files)': " (dont {n} fichiers à l'ancien format)",
  ...
  'Migrating…': 'Migration…',
  'Convert the legacy rows of this file into card blocks (automatic backup). Your memos show up in the feed again afterwards.': "Convertit les lignes à l'ancien format de ce fichier en blocs-cartes (sauvegarde automatique). Vos memos réapparaissent ensuite dans le fil.",
  ...
  'Migration failed: ': 'Échec de la migration : ',
  'no auto-fixable issues': 'aucun problème corrigeable automatiquement',
  'cannot auto-fix further — the remaining issues need manual work or a migration': 'correction automatique impossible — les problèmes restants demandent une intervention manuelle ou une migration',
  ...
  'Migration done: {n} entries converted': 'Migration terminée : {n} entrées converties',
  'Migrated all: {files} files · {n} entries converted': 'Migration complète : {files} fichiers · {n} entrées converties',
  ', {n} cross-day comments moved to their daily notes': ', {n} commentaires inter-journées déplacés dans leur note quotidienne',
  ', {n} deleted comments dropped': ', {n} commentaires supprimés abandonnés',
  ', {n} entries kept as-is (could not be mapped)': ', {n} entrées conservées telles quelles (non mappables)',
  ', failed: {list}': ', échecs : {list}',
  ...
  'Nothing to migrate ({n} lines lack a time and need manual work).': 'Rien à migrer ({n} lignes sans horaire, à traiter manuellement).',
  'This file has no legacy-format lines — no migration needed.': "Ce fichier ne contient pas de lignes à l'ancien format — aucune migration nécessaire.",
  'Legacy <br> line breaks': 'Sauts de ligne <br> hérités',
  'Duplicate ^id': '^id en double',
  'Legacy format row': 'Ligne à l ancien format',
  'Legacy 14-digit timestamp': 'Horodatage hérité à 14 chiffres',
  'Missing ^id': '^id manquant',
  'Your old memos are still here': 'Vos anciens memos sont toujours là',
  'This vault contains {n} memo lines in the old Memos format, which Rememo does not render yet. Nothing is lost — run the data health check to convert them into card blocks.': "Ce coffre contient {n} lignes de memos à l'ancien format Memos, que Rememo n'affiche pas encore. Rien n'est perdu — lancez la vérification des données pour les convertir en blocs-cartes.",
  'Open data health check': 'Ouvrir la vérification des données',
};
